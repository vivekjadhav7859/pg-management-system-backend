    ...
    try {
        ...
        return response.success({
            ...
            tenant: {
                ...
                medicalNotes: tenant.medicalNotes || null,
                vehicleDetails: tenant.vehicleDetails || null,
                profilePhoto: tenant.profilePhoto || null,
                profileCompletionPct: tenant.profileCompletionPct !== undefined ? tenant.profileCompletionPct : (tenant.agreementStatus === 'signed' ? 60 : 40),
                agreementStatus: tenant.agreementStatus || 'pending',
                agreementSignedAt: tenant.agreementSignedAt || null,
                agreementVersion: tenant.agreementVersion || null,
                agreementIp: tenant.agreementIp || null,
